...
class DrugResponseDataset(Dataset):
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        """
        #print(f"cell_line_ids shape: {self.cell_line_ids.shape}")
        #print(f"drug_ids shape: {self.drug_ids.shape}")
        #print(f"response shape: {self.response.shape}")
        if self._predictions is not None:
            #print(f"predictions shape: {self._predictions.shape}")
        ...
        if self._predictions is not None:
            data["predictions"] = self._predictions
