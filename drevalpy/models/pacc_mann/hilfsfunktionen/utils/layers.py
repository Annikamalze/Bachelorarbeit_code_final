...
class ContextAttentionLayer(nn.Module):
    ...
    def forward(
        ...
        #print("Referece_Attention_Shape:",reference_attention.shape)
        #print("Context_Attention_Shape:",context_attention.shape)

        #print("reference:",reference_attention[0, :10])  # Zeigt die ersten 10 Elemente der zweiten Dimension des ersten Batches
        #print("context:",context_attention[0, :10])
